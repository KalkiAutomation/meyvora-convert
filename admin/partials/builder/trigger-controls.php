...
<div class="meyvc-trigger-controls">

	<!-- Trigger Type -->
	<div class="meyvc-control-group">
		<label><?php esc_html_e( 'Trigger Type', 'meyvora-convert' ); ?></label>

		<div class="meyvc-trigger-types">

			<label class="meyvc-trigger-option">
				<input type="radio" name="trigger-type" value="exit_intent"
					   <?php checked( $trigger['type'] ?? 'exit_intent', 'exit_intent' ); ?> />
				<div class="meyvc-trigger-card">
					<span class="meyvc-trigger-icon"><?php echo wp_kses( MEYVC_Icons::svg( 'door-open', array( 'class' => 'meyvc-ico' ) ), MEYVC_Icons::get_svg_kses_allowed() ); ?></span>

					<span class="meyvc-trigger-name"><?php esc_html_e( 'Exit Intent', 'meyvora-convert' ); ?></span>
					<span class="meyvc-trigger-desc"><?php esc_html_e( 'When visitor is about to leave', 'meyvora-convert' ); ?></span>
				</div>
			</label>
			...
			<label class="meyvc-trigger-option">
				...
				<div class="meyvc-trigger-card">
					<span class="meyvc-trigger-icon"><?php echo wp_kses( MEYVC_Icons::svg( 'pointer', array( 'class' => 'meyvc-ico' ) ), MEYVC_Icons::get_svg_kses_allowed() ); ?></span>

					<span class="meyvc-trigger-name"><?php esc_html_e( 'Mobile exit intent', 'meyvora-convert' ); ?></span>
					<span class="meyvc-trigger-desc"><?php esc_html_e( 'Phones/tablets: fast scroll up, back button, tab switch', 'meyvora-convert' ); ?></span>
				</div>
			</label>
			...
			<label class="meyvc-trigger-option">
				...
				<div class="meyvc-trigger-card">
					<span class="meyvc-trigger-icon"><?php echo wp_kses( MEYVC_Icons::svg( 'scroll', array( 'class' => 'meyvc-ico' ) ), MEYVC_Icons::get_svg_kses_allowed() ); ?></span>

					<span class="meyvc-trigger-name"><?php esc_html_e( 'Scroll Depth', 'meyvora-convert' ); ?></span>
					<span class="meyvc-trigger-desc"><?php esc_html_e( 'When visitor scrolls to a point', 'meyvora-convert' ); ?></span>
				</div>
			</label>
			...
			<label class="meyvc-trigger-option">
				...
				<div class="meyvc-trigger-card">
					<span class="meyvc-trigger-icon"><?php echo wp_kses( MEYVC_Icons::svg( 'clock', array( 'class' => 'meyvc-ico' ) ), MEYVC_Icons::get_svg_kses_allowed() ); ?></span>

					<span class="meyvc-trigger-name"><?php esc_html_e( 'Time Delay', 'meyvora-convert' ); ?></span>
					<span class="meyvc-trigger-desc"><?php esc_html_e( 'After X seconds on page', 'meyvora-convert' ); ?></span>
				</div>
			</label>
			...
			<label class="meyvc-trigger-option">
				...
				<div class="meyvc-trigger-card">
					<span class="meyvc-trigger-icon"><?php echo wp_kses( MEYVC_Icons::svg( 'moon', array( 'class' => 'meyvc-ico' ) ), MEYVC_Icons::get_svg_kses_allowed() ); ?></span>

					<span class="meyvc-trigger-name"><?php esc_html_e( 'Inactivity', 'meyvora-convert' ); ?></span>
					<span class="meyvc-trigger-desc"><?php esc_html_e( 'When visitor stops interacting', 'meyvora-convert' ); ?></span>
				</div>
			</label>
			...
			<label class="meyvc-trigger-option">
				...
				<div class="meyvc-trigger-card">
					...
					<span class="meyvc-trigger-name"><?php esc_html_e( 'Click', 'meyvora-convert' ); ?></span>
					<span class="meyvc-trigger-desc"><?php esc_html_e( 'When element is clicked', 'meyvora-convert' ); ?></span>
				</div>
			</label>
	...
	<!-- Exit Intent Options -->
	<div class="meyvc-trigger-options meyvc-is-hidden" data-trigger="mobile_exit">
		<p class="meyvc-hint"><?php esc_html_e( 'Fires only on mobile/tablet. Desktop visitors will not match this trigger.', 'meyvora-convert' ); ?></p>
	</div>

	<div class="meyvc-trigger-options" data-trigger="exit_intent">
		<div class="meyvc-control-group">
			<label><?php esc_html_e( 'Sensitivity', 'meyvora-convert' ); ?></label>
			<select id="trigger-sensitivity" class="meyvc-selectwoo" data-placeholder="<?php esc_attr_e( 'Medium (balanced)', 'meyvora-convert' ); ?>">
		...
		<div class="meyvc-control-group">
			...
			<p class="meyvc-hint"><?php esc_html_e( 'Detects back button, fast scroll up, and tab switch on mobile', 'meyvora-convert' ); ?></p>
		</div>
	</div>

	<!-- Scroll Options -->
	<div class="meyvc-trigger-options meyvc-is-hidden" data-trigger="scroll">
		<div class="meyvc-control-group">
			...
			<div class="meyvc-range-slider">
				...
				<span class="meyvc-range-value"><span id="scroll-depth-value"><?php echo esc_html( (string) $scroll_depth ); ?></span>%</span>
			</div>
		</div>
	</div>

	<!-- Time Options -->
	<div class="meyvc-trigger-options meyvc-is-hidden" data-trigger="time">
		<div class="meyvc-control-group">
			...
			<div class="meyvc-input-with-suffix">
				...
				<span class="meyvc-suffix"><?php esc_html_e( 'seconds', 'meyvora-convert' ); ?></span>
			</div>
		</div>
	</div>

	<!-- Inactivity Options -->
	<div class="meyvc-trigger-options meyvc-is-hidden" data-trigger="inactivity">
		<div class="meyvc-control-group">
	...
	<!-- Click Options -->
	<div class="meyvc-trigger-options meyvc-is-hidden" data-trigger="click">
		<div class="meyvc-control-group">
			...
			<p class="meyvc-hint"><?php esc_html_e( 'Enter CSS selector for elements that trigger the popup', 'meyvora-convert' ); ?></p>
		</div>
	</div>
	...
	<div class="meyvc-control-group">
		...
		<p class="meyvc-hint"><?php esc_html_e( 'Wait this long after trigger before showing popup', 'meyvora-convert' ); ?></p>
	</div>

	<!-- Intent Threshold (Advanced) -->
	<div class="meyvc-control-group meyvc-advanced-toggle">
		<label>
	...
	<div class="meyvc-advanced-options <?php echo ! empty( $trigger['use_custom_intent'] ) ? '' : 'meyvc-is-hidden'; ?>" id="intent-settings">
		<p class="meyvc-hint"><?php esc_html_e( 'Adjust weights for different exit signals. Higher = more important.', 'meyvora-convert' ); ?></p>

		<div class="meyvc-intent-signals">
			<?php $ew = (int) ( $intent_weights['exit_mouse'] ?? 40 ); ?>
			<div class="meyvc-signal-weight">
		...
		<div class="meyvc-control-group">
			...
			<div class="meyvc-range-slider">
				...
				<span class="meyvc-range-value"><span id="intent-threshold-value"><?php echo esc_html( (string) $threshold ); ?></span></span>
			</div>
			<p class="meyvc-hint"><?php esc_html_e( 'Combined signal score must reach this threshold to trigger', 'meyvora-convert' ); ?></p>
		</div>
	</div>
