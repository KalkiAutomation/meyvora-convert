...
if ( class_exists( 'MEYVC_Campaign' ) ) {
	foreach ( MEYVC_Campaign::get_all( array( 'limit' => 300 ) ) as $meyvc_row ) {
		if ( (int) ( $meyvc_row['id'] ?? 0 ) !== $campaign_id ) {
			$other_campaigns[] = $meyvc_row;
		}
	}
}

// Show success notice if campaign was duplicated
if ( MEYVC_Security::get_query_var( 'duplicated' ) === '1' ) {
...
$default_targeting = MEYVC_Activator::get_default_targeting_rules();
...
if ( isset( $_POST['meyvc_save_campaign'] ) && isset( $_POST['meyvc_nonce'] ) && wp_verify_nonce( sanitize_text_field( wp_unslash( $_POST['meyvc_nonce'] ) ), 'meyvc_save_campaign' ) ) {
	...
	if ( isset( $_POST['targeting'] ) && is_array( $_POST['targeting'] ) ) {
		...
		if ( isset( $_POST['targeting']['behavior'] ) ) {
			...
			$behavior['cart_min_value']      = isset( $_POST['targeting']['behavior']['cart_min_value'] ) ? floatval( wp_unslash( $_POST['targeting']['behavior']['cart_min_value'] ) ) : 0;
			$behavior['cart_max_value']      = isset( $_POST['targeting']['behavior']['cart_max_value'] ) ? floatval( wp_unslash( $_POST['targeting']['behavior']['cart_max_value'] ) ) : 0;
	...
	if ( $campaign_id > 0 ) {
		...
		if ( $new_id ) {
			...
			wp_safe_redirect( admin_url( 'admin.php?page=meyvc-campaign-edit&campaign_id=' . $new_id ) );
			exit;
		}
	}
}
...
<h1><?php echo esc_html( $campaign_id > 0 ? __( 'Edit Campaign', 'meyvora-convert' ) : __( 'Add New Campaign', 'meyvora-convert' ) ); ?></h1>
	<a href="<?php echo esc_url( admin_url( 'admin.php?page=meyvc-campaigns' ) ); ?>" class="page-title-action"><?php esc_html_e( '&larr; Back to Campaigns', 'meyvora-convert' ); ?></a>

	<form method="post">
		<?php wp_nonce_field( 'meyvc_save_campaign', 'meyvc_nonce' ); ?>

		<div class="meyvc-settings-section">
			<div class="meyvc-fields-grid meyvc-fields-grid--1col">
				<div class="meyvc-field meyvc-col-12">
					<label for="campaign_name" class="meyvc-field__label"><?php esc_html_e( 'Campaign Name', 'meyvora-convert' ); ?></label>
				...
				<div class="meyvc-field meyvc-col-12">
					<label for="campaign_type" class="meyvc-field__label"><?php esc_html_e( 'Campaign Type', 'meyvora-convert' ); ?></label>
					<div class="meyvc-field__control">
						<select id="campaign_type" name="campaign_type" class="meyvc-selectwoo" data-placeholder="<?php esc_attr_e( 'Exit Intent', 'meyvora-convert' ); ?>">
				...
				<div class="meyvc-field meyvc-col-12">
					<label for="campaign_status" class="meyvc-field__label"><?php esc_html_e( 'Status', 'meyvora-convert' ); ?></label>
					<div class="meyvc-field__control">
						<select id="campaign_status" name="campaign_status" class="meyvc-selectwoo" data-placeholder="<?php esc_attr_e( 'Draft', 'meyvora-convert' ); ?>">
		...
		<div class="meyvc-settings-section">
			<h2>
				<?php echo wp_kses( MEYVC_Icons::svg( 'user', array( 'class' => 'meyvc-ico' ) ), MEYVC_Icons::get_svg_kses_allowed() ); ?>
			...
			<div class="meyvc-fields-grid meyvc-fields-grid--1col">
				<div class="meyvc-field meyvc-col-12">
					<label class="meyvc-field__label"><?php esc_html_e( 'Time on Page', 'meyvora-convert' ); ?></label>
					<div class="meyvc-field__control">
						<label>
					...
					<span class="meyvc-help"><?php esc_html_e( 'Wait until visitor has been on page this long. 0 = no minimum.', 'meyvora-convert' ); ?></span>
				</div>
				<div class="meyvc-field meyvc-col-12">
					<label class="meyvc-field__label"><?php esc_html_e( 'Scroll Depth', 'meyvora-convert' ); ?></label>
					<div class="meyvc-field__control">
						<label>
					...
					<span class="meyvc-help"><?php esc_html_e( 'Visitor must scroll this far before trigger. 0 = no minimum.', 'meyvora-convert' ); ?></span>
				</div>
				<div class="meyvc-field meyvc-col-12">
					<div class="meyvc-field__control">
						<label>
					...
					<span class="meyvc-help"><?php esc_html_e( 'Ensures visitor is engaged, not just bouncing.', 'meyvora-convert' ); ?></span>
				</div>
				<div class="meyvc-field meyvc-col-12">
					<label for="cart_status" class="meyvc-field__label"><?php esc_html_e( 'Cart Status', 'meyvora-convert' ); ?></label>
					<div class="meyvc-field__control">
						<select id="cart_status" name="targeting[behavior][cart_status]" class="meyvc-selectwoo" data-placeholder="<?php esc_attr_e( 'Any (show regardless of cart)', 'meyvora-convert' ); ?>">
				...
				<div class="meyvc-field meyvc-col-12">
					<label class="meyvc-field__label"><?php esc_html_e( 'Cart Value', 'meyvora-convert' ); ?></label>
					<div class="meyvc-field__control">
						<label>
					...
					<span class="meyvc-help"><?php esc_html_e( 'Set to 0 for no limit.', 'meyvora-convert' ); ?></span>
				</div>
				<div class="meyvc-field meyvc-col-12">
					<label for="visitor_type" class="meyvc-field__label"><?php esc_html_e( 'Visitor Type', 'meyvora-convert' ); ?></label>
					<div class="meyvc-field__control">
						<select id="visitor_type" name="targeting[visitor][type]" class="meyvc-selectwoo" data-placeholder="<?php esc_attr_e( 'All visitors', 'meyvora-convert' ); ?>">
				...
				<div class="meyvc-field meyvc-col-12">
					<label class="meyvc-field__label"><?php esc_html_e( 'Device', 'meyvora-convert' ); ?></label>
					<div class="meyvc-field__control">
						<label>
		...
		?>
		<div class="meyvc-settings-section" id="meyvc-fallback-campaign-section">
			<h2><?php esc_html_e( 'Fallback Campaign', 'meyvora-convert' ); ?></h2>
			<p class="meyvc-section-description"><?php esc_html_e( 'After a visitor closes this popup, you can show another campaign after a short delay.', 'meyvora-convert' ); ?></p>
			<div class="meyvc-fields-grid meyvc-fields-grid--1col">
				<div class="meyvc-field meyvc-col-12 meyvc-field-row">
					<label for="fallback_id" class="meyvc-field__label"><?php esc_html_e( 'If dismissed, show this campaign:', 'meyvora-convert' ); ?></label>
					<div class="meyvc-field__control">
						<select name="fallback_id" id="fallback_id" class="meyvc-selectwoo widefat">
				...
				<div class="meyvc-field meyvc-col-12 meyvc-field-row" id="meyvc-fallback-delay-row" style="<?php echo $fb_id_edit > 0 ? '' : 'display:none;'; ?>">
					<label for="fallback_delay_seconds" class="meyvc-field__label"><?php esc_html_e( 'After delay (seconds):', 'meyvora-convert' ); ?></label>
					<div class="meyvc-field__control">
		...
		<?php submit_button( __( 'Save Campaign', 'meyvora-convert' ), 'primary', 'meyvc_save_campaign' ); ?>
	</form>
