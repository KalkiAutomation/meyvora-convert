...
class MEYVC_AI_Client {
	...
	public static function get_api_key(): string {
		...
		$enc = meyvc_settings()->get( 'ai', 'anthropic_api_key_enc', '' );
		if ( is_string( $enc ) && $enc !== '' && class_exists( 'MEYVC_Security' ) ) {
			$decrypted = MEYVC_Security::decrypt_secret( $enc );
			if ( is_string( $decrypted ) && $decrypted !== '' ) {
				return $decrypted;
			}
		}
		$key = meyvc_settings()->get( 'ai', 'anthropic_api_key', '' );
