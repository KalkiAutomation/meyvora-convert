...
/**
 * MEYVC_Gutenberg_Block class.
 */
class MEYVC_Gutenberg_Block {
	...
	public static function register_block() {
		...
		$block_json = defined( 'MEYVC_PLUGIN_DIR' ) ? MEYVC_PLUGIN_DIR . 'blocks/campaign/block.json' : '';
	 ...
	 * Uses the same output as the [meyvc_campaign] shortcode.
	 *
	...
	public static function render_campaign_block( $attributes, $content, $block ) {
		...
		return do_shortcode( '[meyvc_campaign id="' . $id . '"]' );
	}
	...
	public static function enqueue_editor_assets() {
		$script_asset_path = MEYVC_PLUGIN_DIR . 'blocks/campaign/index.asset.php';
		$script_path      = MEYVC_PLUGIN_DIR . 'blocks/campaign/index.js';
		$script_url       = MEYVC_PLUGIN_URL . 'blocks/campaign/index.js';
