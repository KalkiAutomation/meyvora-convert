...
class MEYVC_Offer_Guard {
	 ...
	 *
	 * @param MEYVC_Visitor_State $visitor_state Visitor state instance.
	 * @param string            $coupon_code   Coupon code.
	 * @return bool
	 */
	...
	public function get_max_discount( $cart_total ) {
		$max_percent = meyvc_settings()->get( 'general', 'max_discount_percent', 25 );
