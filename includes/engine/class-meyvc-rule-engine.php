 ...
 * Rule engine
 *
 * Evaluates rules against MEYVC_Context. Supports must (AND), should (OR), must_not (NOT)
...
class MEYVC_Rule_Engine {
	 ...
	 * @param MEYVC_Context $context Context instance.
