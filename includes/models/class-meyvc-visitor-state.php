 ...
 */
class MEYVC_Visitor_State {

	/** Cookie name (compact). */
	const COOKIE_NAME = 'meyvc_vs';

	/** Cookie for banner view counts (readable by JS for blocks). Not httponly. */
	const BANNER_VIEWS_COOKIE = 'meyvc_banner_views';
	...
	private function generate_visitor_id() {
		return 'meyvc_' . bin2hex( random_bytes( 16 ) );
	}
