...
// Build classes
$classes = [ 'meyvc-popup', 'meyvc-popup--fullscreen' ];
if ( $is_preview ) {
...
?>
<?php if ( $is_preview ) : ?>
<div class="meyvc-preview-viewport meyvc-preview-viewport--fullscreen">
<?php endif; ?>
...
<div class="<?php echo esc_attr( implode( ' ', $classes ) ); ?>"
    ...
    <!-- Close Button -->
    <button type="button" class="meyvc-popup__close meyvc-popup__close--light" aria-label="<?php esc_attr_e( 'Close', 'meyvora-convert' ); ?>" data-action="close">
    ...
    <!-- Background Image -->
    <div class="meyvc-popup__background" style="background-image: url('<?php echo esc_url( $content['image_url'] ); ?>');"></div>
    <?php endif; ?>
    ...
    <div class="meyvc-popup__inner">
        ...
        <h1 class="meyvc-popup__headline" id="meyvc-headline-<?php echo esc_attr( $campaign_id ); ?>"
